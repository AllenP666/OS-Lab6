...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), currentPeriodSeconds(60)
{
    setupUi();
...
void MainWindow::setupUi() {
    ...
    QFont fontAvg = averageTempLabel->font();
    fontAvg.setPointSize(14);
    averageTempLabel->setFont(fontAvg);
    ...
    resize(900, 600);
    setWindowTitle("Weather Station GUI (Lab 6)");
}
...
void MainWindow::updateCurrentData() {
    ...
    connect(reply, &QNetworkReply::finished, [this, reply](){ onCurrentDataReceived(reply); });
}
...
void MainWindow::updateHistoryData() {
    ...
    QNetworkReply *reply = networkManager->get(request);
    connect(reply, &QNetworkReply::finished, [this, reply](){ onHistoryDataReceived(reply); });
}
